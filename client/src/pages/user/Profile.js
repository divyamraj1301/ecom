...
const Profile = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axios.put(`${serverAPI}/auth/profile`, { name, email, password, phone, address });
                        ...
                        <div className='form-container'>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input email="text" value={email} onChange={(e) => setEmail(e.target.value)} className="form-control" id="exampleInputEmail" placeholder='Enter Your Email' disabled />
                                </div>
                                <div className="mb-3">
