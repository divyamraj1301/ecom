...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`${serverAPI}/auth/register`, { name, email, password, phone, address, answer });
            ...
            <div className="form-container">
                ...
                <h4 className="title">REGISTER PAGE</h4>
                    ...
                    <div className="mb-3">
                        ...
                        <input email="text" value={email} onChange={(e) => setEmail(e.target.value)} className="form-control" id="exampleInputEmail" placeholder='Enter Your Email' required />
                    </div>
                    <div className="mb-3">
